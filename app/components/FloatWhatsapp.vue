  ...
  <Teleport to="body">
    ...
    >
      <div class="relative">
        ...
        <div class="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110">
...
const props = defineProps({
  ...
  message: {
    type: String,
    default: 'Hola, me gustaría obtener más información sobre las parcelas.'
  }
})
