    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex flex-wrap gap-2">
        <div 
          ...
          :class="terreno.valor === 'vendida' ? 'bg-gray-100 border-gray-300' : 'bg-amber-50 border-[#FFD1D1] hover:border-[#FF5858] '"
        >
      ...
      <div class="mt-16 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 md:p-12 border-2 border-[#FFD1D1] hover:border-[#FF5858] transition-all shadow-lg">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <a 
            ...
            target="_blank"
            class="inline-flex items-center gap-2 bg-[#FF5858] text-white font-semibold px-8 py-4 rounded-full transition-all shadow-md hover:shadow-xl transform hover:-translate-y-1"
          >
